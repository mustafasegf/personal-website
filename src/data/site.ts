...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "CPU emulator in Rust implementing the Intel 8080 instruction set, complete enough to run an asteroid game",
    tags: ["Rust", "Emulator", "Macroquad"],
    github: "https://github.com/mustafasegf/intel-8080-emu",
    color: "bg-brand-rose",
  },
  {
    title: "Rust Redis Clone",
    desc: "Redis-compatible server with async TCP handling and RESP protocol parsing, built for the CodeCrafters challenge",
    tags: ["Rust", "Tokio", "TCP"],
  ...
  },
  {
    ...
    desc: "Platform-as-a-service built from scratch in Rust and Docker, serving 400+ deployments as a single binary",
  ...
  {
    title: "CUDA 100 Days",
    desc: "CUDA kernels and GPU optimization techniques for high-performance computing, one day at a time",
    tags: ["CUDA", "C++", "GPU"],
  ...
  },
  {
    ...
    desc: "C language parser in OCaml generating an abstract syntax tree for a defined C subset",
    tags: ["OCaml", "Compiler", "AST"],
