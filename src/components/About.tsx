...
export function About() {
  return (
    <section id="about" className="scroll-mt-16 border-b-2 bg-brand-blue px-6 py-14 sm:px-10">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-6 space-y-4 leading-relaxed text-pretty">
          <p>
            ...
            Kubernetes, and the plumbing that keeps models training and serving reliably. I'm also able to do backend and frontend
            engineering, work with cloud on GCP and AWS, and play with system engineering projects.
          </p>
          <p>
            ...
            , keeping on-prem GPU servers reliable with end-to-end telemetry, Kubernetes, and infrastructure as code. You can also checkout
